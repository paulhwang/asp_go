...
function PhwangSessionClass(link_object_val) {
    ...
    this.incrementXmtSeq = function() { this.theXmtSeq += 1; };
    this.rcvSeq = () => this.theRcvSeq;
    this.incrementRcvSeq = function() { this.theRcvSeq += 1; };
    ...
    this.phwangSessionStorageObject = () => this.thePhwangSessionStorageObject;
    ...
    this.sessionId = () => this.phwangSessionStorageObject().sessionId();
